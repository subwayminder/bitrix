...
if($arParams['NOMAPS']!='Y')
    $APPLICATION->AddHeadString('<script data-id="'.CDeliverySDEK::$MODULE_ID.'" src="'.Ipolh\SDEK\pvzWidjetHandler::getMapsScript().'" type="text/javascript"></script>');
    ...
    var IPOLSDEK_pvz = {
        ...
        loadCityCost: function(){
            ...
            if(IPOLSDEK_pvz.logging){
                console.log(IPOLSDEK_pvz.label + ': requesting prices',data);
            }
