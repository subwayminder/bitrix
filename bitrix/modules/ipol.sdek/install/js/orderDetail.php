...
<?=sdekdriver::getModuleExt('packController')?>
    ...
    <style type='text/css'>
        ...
        #IPOLSDEK_searchPVZ,#IPOLSDEK_noSearchPVZ{
            cursor: pointer;
            width: 15px;
            height: 15px;
        }
        ...
        #IPOLSDEK_noSearchPVZ{
            display:none;
            background: url("/bitrix/images/<?=self::$MODULE_ID?>/delPack.png") !important;
        }
        #IPOLSDEK_searchPVZPlace{
            display: none;
        }
    ...
    <script>
        ...
        var IPOLSDEK_oExport = {
            ...
            searchPVZ: {
                on: function(){
                    $('#IPOLSDEK_searchPVZ').css('display','none');
                    $('#IPOLSDEK_noSearchPVZ').css('display','inline-block');
                    $('#IPOLSDEK_PVZ').attr('size',5);
                    $('#IPOLSDEK_searchPVZPlace').css('display','block');
                    $('#IPOLSDEK_sendBtn').attr('disabled','disabled');
                },
                off : function(){
                    $('#IPOLSDEK_searchPVZ').css('display','inline-block');
                    $('#IPOLSDEK_noSearchPVZ').css('display','none');
                    $('#IPOLSDEK_PVZ').removeAttr('size');
                    $('#IPOLSDEK_searchPVZPlace').css('display','none');
                    $('#IPOLSDEK_searchPVZInput').val('');
                    if($('#IPOLSDEK_PVZ option:visible').length === 1){
                        $('#IPOLSDEK_PVZ').val($('#IPOLSDEK_PVZ option:visible').attr('value'));
                    }
                    $('#IPOLSDEK_PVZ option').each(function(){$(this).css('display','');});
                    $('#IPOLSDEK_sendBtn').removeAttr('disabled');
                },
                search : function(){
                    var text = $('#IPOLSDEK_searchPVZInput').val().toLowerCase();
                    $('#IPOLSDEK_PVZ option').each(function(){
    ...
    <div style='display:none'>
        <table id='IPOLSDEK_wndOrder'>
            ...
            <tr class='IPOLSDEK_SV'><td><?=GetMessage('IPOLSDEK_JS_SOD_PVZ')?>
                    <?if($strOfPSV){?>&nbsp;<span id="IPOLSDEK_searchPVZ" onclick='IPOLSDEK_oExport.searchPVZ.on();'></span><span id="IPOLSDEK_noSearchPVZ" onclick='IPOLSDEK_oExport.searchPVZ.off();'></span><?}?></td>
                <td>
                    <?if($strOfPSV){?>
                        <span id="IPOLSDEK_searchPVZPlace"><?=GetMessage('IPOLSDEK_JS_SOD_SEARCHPVZ')?>:&nbsp;<input type="text" id="IPOLSDEK_searchPVZInput" onkeyup="IPOLSDEK_oExport.searchPVZ.search()"></span>
